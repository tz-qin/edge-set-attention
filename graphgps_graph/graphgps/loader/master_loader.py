...
from data_loading.data_loading import get_dataset_train_val_test_with_indices_for_graphgps
...
def load_dataset_master(format, name, dataset_dir):
    ...
    dataset, scaler = get_dataset_train_val_test_with_indices_for_graphgps(name, dataset_dir, one_hot=one_hot, target_name=target_name)
    ...
    precomputed_path = os.path.join(cfg.dataset.dir, f'{cfg.dataset.name}_{cfg.dataset.target_name}_precomputed_posenc.pt')
