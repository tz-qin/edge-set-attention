...
def make_wandb_name(cfg):
    ...
    name = f"{dataset_name}.{model_name}.{cfg.dataset.target_name}.{cfg.dataset.inductive_or_transductive}.{cfg.dataset.hq_or_lq}.L={cfg.gt.layers}.D={cfg.gt.dim_hidden}.H={cfg.gt.n_heads}.seed={cfg.seed}"
    return name
