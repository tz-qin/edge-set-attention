...
from data_loading.data_loading_transfer_learning_QM9_3D import get_dataset_train_val_test_with_indices_for_graphgps
...
def load_dataset_master(format, name, dataset_dir):
    ...
    hq_or_lq = cfg.dataset.hq_or_lq
    ind_or_trans = cfg.dataset.inductive_or_transductive

    dataset, scaler = get_dataset_train_val_test_with_indices_for_graphgps(dataset_dir, target_name=target_name, hq_or_lq=hq_or_lq, ind_or_trans=ind_or_trans)
    ...
    precomputed_path = os.path.join(cfg.dataset.dir, f'{cfg.dataset.name}_{cfg.dataset.target_name}_{cfg.dataset.hq_or_lq}_{cfg.dataset.inductive_or_transductive}_precomputed_posenc.pt')
